...
# Define SQL errors
sql_errors = ["Syntax error", "Fatal error", "MariaDB", "corresponds", "Database Error", "syntax", "/home/", "/usr/www", "occured", "public_html", "SQL", "database error", "on line", "RuntimeException", "mysql_", "Warning", "MySQL", "PSQLException", "at line", "You have an error in your SQL syntax", "mysql_query()", "pg_connect()"]
